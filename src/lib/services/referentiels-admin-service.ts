...
function parseEntrepotFormData(formData: FormData) {
  return entrepotSchema.safeParse({
    ...
    temperatureMoyenne: formData.get("temperatureMoyenne") || undefined,
    temperatureMin: formData.get("temperatureMin") || undefined,
    temperatureMax: formData.get("temperatureMax") || undefined,
    systemeClimatisation: formData.get("systemeClimatisation") === "on",
    climatisationFonctionnelle: formData.get("climatisationFonctionnelle") === "on",
    humiditeMoyenne: formData.get("humiditeMoyenne") || undefined,
    humiditeMin: formData.get("humiditeMin") || undefined,
    humiditeMax: formData.get("humiditeMax") || undefined,
    deshumidificateur: formData.get("deshumidificateur") === "on",
    systemeControleHumidite: formData.get("systemeControleHumidite") === "on",
    protectionEau: formData.get("protectionEau") === "on",
    protectionInfiltrations: formData.get("protectionInfiltrations") === "on",
    etancheiteBatiment: formData.get("etancheiteBatiment") === "on",
    protectionPoussiere: formData.get("protectionPoussiere") === "on",
    protectionNuisibles: formData.get("protectionNuisibles") === "on",
    extincteursDisponibles: formData.get("extincteursDisponibles") === "on",
    nombreExtincteurs: formData.get("nombreExtincteurs") || undefined,
    detecteursFumee: formData.get("detecteursFumee") === "on",
    systemeAlarmeIncendie: formData.get("systemeAlarmeIncendie") === "on",
    systemeExtinctionAutomatique: formData.get("systemeExtinctionAutomatique") === "on",
    dateDernierControleIncendie: formData.get("dateDernierControleIncendie"),
    dateProchainControleIncendie: formData.get("dateProchainControleIncendie"),
    gardiennage: formData.get("gardiennage") === "on",
    videosurveillance: formData.get("videosurveillance") === "on",
    nombreCameras: formData.get("nombreCameras") || undefined,
    alarmeAntiIntrusion: formData.get("alarmeAntiIntrusion") === "on",
    controleAcces: formData.get("controleAcces") === "on",
...
function entrepotDataFromInput(input: z.infer<typeof entrepotSchema>) {
  ...
  return {
    ...
    temperatureMoyenne: num(input.temperatureMoyenne),
    temperatureMin: num(input.temperatureMin),
    temperatureMax: num(input.temperatureMax),
    systemeClimatisation: input.systemeClimatisation,
    climatisationFonctionnelle: input.climatisationFonctionnelle,
    humiditeMoyenne: num(input.humiditeMoyenne),
    humiditeMin: num(input.humiditeMin),
    humiditeMax: num(input.humiditeMax),
    deshumidificateur: input.deshumidificateur,
    systemeControleHumidite: input.systemeControleHumidite,
    protectionEau: input.protectionEau,
    protectionInfiltrations: input.protectionInfiltrations,
    etancheiteBatiment: input.etancheiteBatiment,
    protectionPoussiere: input.protectionPoussiere,
    protectionNuisibles: input.protectionNuisibles,
    extincteursDisponibles: input.extincteursDisponibles,
    nombreExtincteurs: num(input.nombreExtincteurs),
    detecteursFumee: input.detecteursFumee,
    systemeAlarmeIncendie: input.systemeAlarmeIncendie,
    systemeExtinctionAutomatique: input.systemeExtinctionAutomatique,
    dateDernierControleIncendie: input.dateDernierControleIncendie ? new Date(input.dateDernierControleIncendie) : null,
    dateProchainControleIncendie: input.dateProchainControleIncendie ? new Date(input.dateProchainControleIncendie) : null,
    gardiennage: input.gardiennage,
    videosurveillance: input.videosurveillance,
    nombreCameras: num(input.nombreCameras),
    alarmeAntiIntrusion: input.alarmeAntiIntrusion,
    controleAcces: input.controleAcces,
    badge: input.badge,
